...
| -------------------------- | ------------------------------------------------------------------- |
| `main.tf`                  | Core AWS resources: VPC, subnets, routing, EC2, ALB, etc.           |
| `provider.tf`              | AWS provider configuration and region settings                      |
| `variables.tf`             | Input variables for infrastructure parameters                       |
| `userdata1.sh`             | User data script for EC2 instance 1 (Apache web server setup)       |
| `userdata2.sh`             | User data script for EC2 instance 2 (Apache web server setup)       |
| `install.md`               | Instructions to install and set up Terraform environment            |
| `aws-connection.md`        | Guide to configure AWS credentials and permissions                  |
| `output-screen-shorts.pdf` | PDF file containing screenshots of Terraform output and AWS console |
